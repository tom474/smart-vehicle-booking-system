...
import { ChevronRight, Car, Dot, UserRoundPen } from "lucide-react";
			...
			<div className="flex-1 min-w-0 space-y-2">
				...
				{activity.executive && (
					<div className="flex flex-row items-center gap-2">
						<UserRoundPen className="flex-shrink-0" />
						<div className="flex flex-col items-start min-w-0">
							<span className="text-subtitle-2">
								{t("executive")}: {activity.executive.name}
							</span>
							<span className="text-body-2 text-muted-foreground">{activity.executive.email}</span>
						</div>
					</div>
				)}
